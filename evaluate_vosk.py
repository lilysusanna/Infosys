...
Usage:
  python scripts/evaluate_vosk.py --model models/vosk-model-en-us-0.22 --wav data/test_16k_mono.wav --gt data/test_16k_mono.txt
"""
import argparse
import os
import wave
...
def main():
    ...
    # --- Read GT safely (handles UTF-8 and UTF-16 with BOM) ---
    try:
